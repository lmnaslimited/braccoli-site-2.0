...
import { Tbutton, TheroProps, TformMode, Tpricing } from "@repo/ui/type";
...
export default function Pricing({ idPricing }: { idPricing: Tpricing }) {
        ...
        <>
            ...
            <div ref={LdSectionRefs("containerOne")}>
                <div className="bg-grayBackground">
                    <Hero idHero={{
                        ...idPricing.heroSection,
                        buttons: idPricing.heroSection.buttons?.map((idButton) => ({
                            ...idButton,
                            icon: (
