                    ...
                    >
                        ...
                        <div className="text-left space-y-6 max-w-md">
                            <div className="space-y-4">
                                <h1 className="text-5xl md:text-6xl font-bold text-primary leading-none">Ooops!</h1>
                                <p className="text-muted-foreground text-lg leading-relaxed">
                                    We&apos;re currently working behind the scenes. Check back in{" "}
                                    <span className="font-semibold text-primary">5 minutes</span> — meanwhile enjoy your coffee!
                                </p>
                            </div>
                            ...
                            <div className="max-w-xs">
                                ...
                                <p className="text-sm text-muted-foreground">Thanks for your patience!</p>
                            </div>
                            ...
                            <div className="flex gap-4">
                                <button
                                    onClick={() => reset()}
                                    className="px-6 py-2 bg-foreground text-background rounded-lg hover:ring-1 hover:ring-black transition-colors"
                                >
                                    Try again
                                </button>
                            </div>
