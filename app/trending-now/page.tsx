        ...
        <section className="relative overflow-hidden border-b border-border/40 py-20 md:py-32">
          <div className="container relative z-10 mx-auto px-4 md:px-6">
            <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
              ...
              <p className="max-w-[85%] text-gray-500 md:text-xl/relaxed mx-auto">
                In today's fast-paced digital landscape, staying updated is crucial. Unlike social media's overwhelming
                noise, LMNAs brings you{" "}
            ...
            <div className="mx-auto max-w-[58rem]">
                ...
                <div className="relative mx-auto max-w-4xl p-6 md:p-10 bg-white rounded-xl shadow-lg border border-gray-200">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto">
                      Today's digital landscape is overwhelming. The constant barrage of notifications, updates, and
                      content creates more noise than signal.
                    </p>
                  </div>
              ...
              <div className="mt-16 text-center bg-gradient-to-r from-gray-50 to-gray-100 p-8 rounded-xl border border-gray-200">
                <p className="text-lg font-medium mb-6">
                  <span className="font-bold">LMNAs cuts through the noise</span> to deliver only the insights that
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-4">
                <div>
                  ...
                  <p className="text-gray-500 mt-2 max-w-2xl">
                    Stay updated with the latest innovations, industry insights, and AI-driven solutions from LMNAs
                    Cloud Solutions.
                  </p>
                </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="mx-auto max-w-[58rem] text-center">
              ...
              <p className="text-gray-500 mb-8 max-w-[85%] mx-auto">
                Want to be the first to know about the latest trends, innovations, and AI-powered solutions? Subscribe
                to our exclusive insights and never miss a game-changing update!
              </p>
        ...
        <div className="container flex flex-col gap-6 py-12 px-4 md:px-6 md:flex-row md:justify-between">
          <div className="flex flex-col gap-6 md:w-1/3">
            ...
            <p className="text-sm text-gray-500">
              LMNAs Cloud Solutions provides data-driven trends, industry insights, and AI-powered innovations to fuel
