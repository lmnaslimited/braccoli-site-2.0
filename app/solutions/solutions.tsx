...
import { TformMode, TsolutionsPageTarget } from "@repo/middleware";
    ...
    return (
        <>
            ...
            <div ref={LdSectionRefs("containerOne")}>
                <Hero idHero={idSolutions.solution.heroSection} onButtonClick={(mode) => fnHandleFormButtonClick(mode as TformMode, "containerOne")} />
