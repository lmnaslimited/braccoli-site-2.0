...
const hero = {
    heading: {
      textWithoutColor:
        "Revolutionize Your Manufacturing with",
      text: "AI-Powered ERP",
      subtitle:
...
const section3={
  ...
  keyFeature:[
    {
      header:{text: "Intelligent Production Planning",
      subtitle:
    ...
    {
      header:{text: "Real-Time Inventory Management",
      subtitle:
    ...
    {
      header:{text: "End-to-End Supply Chain Visibility",
      subtitle:
  ...
  features:[
    ...
    },
    {
     header:{
      ...
      subtitle: "Optimize shipping, receiving, and distribution operations.",
    },
      image:{
...
const section5 = {
  header:{
    ...
    subtitle: "Join hundreds of manufacturing companies that have streamlined their operations, reduced costs, and increased productivity with LENS ERP Suite.",
    className: "text-center items-center",
    ...
    return (
              ...
              <div key={index} className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-6">
                  <TitleSubtitle iTitle={section.header} />
                   <CustomCard
                      header={{text:section.caseStudy.text, subtitle: section.caseStudy.subtitle}}
        ...
        <section className="mb-24 container mx-auto px-4 md:px-6">
            ...
            <Tab
              ...
              renderItem={(study, index) => (
                <CustomCard
                  key={index}
                  header={{text:study.header.text, subtitle:study.header.subtitle, 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-4">
          {section5.cards.map((card, index)=>(
            <CustomCard
            key={index}
            header={{text:card.header.text, subtitle:card.header.subtitle,
