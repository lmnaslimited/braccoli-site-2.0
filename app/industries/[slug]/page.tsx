...
const pageSlugs = [
  ...
  section6 : {
  ...
  },
    {
      ...
      hero: {
        heading: {
          ...
          text: "AI-Powered ERP",
          subtitle: "Optimize inventory, enhance customer experience, and drive higher sales—all with LENS ERP Suite.",
          badge: "LENS ERP Suite"
        },
        items: [
          {
      ...
      section2: {
        header: {
          ...
          subtitle: "Retailers face unique challenges that traditional systems can't solve. Our ERP solution addresses these pain points directly."
        },
        items: [
          {
            icon: <Boxes className="h-6 w-6 text-primary/70" />, 
            question: "Inconsistent inventory leading to lost sales",
            answer: "Manual stock tracking results in frequent stockouts or overstock, frustrating customers and reducing profitability."
          },
          {
            icon: <BarChart3 className="h-6 w-6 text-primary/70" />,
            question: "Lack of real-time sales visibility across stores",
            answer: "Without centralized tracking, it's difficult to manage multiple locations and keep inventory balanced."
          },
          {
            icon: <Truck className="h-6 w-6 text-primary/70" />,
            question: "Manual order fulfillment causing delays",
            answer: "Inefficient processes lead to slow order processing and missed delivery windows, affecting customer satisfaction."
          },
          {
            icon: <Store className="h-6 w-6 text-primary/70" />,
            question: "Siloed POS, e-commerce, and warehouse systems",
            answer: "Disconnected platforms make omnichannel retailing complex, causing errors and inefficiencies."
          },
          {
            icon: <UserCheck className="h-6 w-6 text-primary/70" />,
            question: "Difficulty in personalizing customer experiences",
            answer: "Without AI-driven insights, it's hard to tailor promotions and recommendations to individual shoppers."
          },
          {
            icon: <TrendingUp className="h-6 w-6 text-primary/70" />,
            question: "Slow response to market trends and demand shifts",
            answer: "Retailers struggle to quickly adapt to changing consumer behavior and seasonal trends without data-driven forecasting."
          }
        ],
        footer: {
          header: {
      ...
      section4: {
        ...
        filters: ["All", "Sales Analytics", "Inventory Control", "Order Management", "Customer Engagement"],
        cards: [
          {
            header: {
    ...
    },
    {
      ...
      hero: {
        heading: {
          textWithoutColor: "LENS ERP Suite: Optimize Your Distribution Network with",
          text: "AI-Powered ERP",
          subtitle: "Enhance supply chain visibility, streamline logistics, and boost operational efficiency with LENS ERP Suite.",
          badge: "LENS ERP Suite"
        },
        items: [
          {
      ...
      section2: {
        header: {
          ...
          subtitle: "Distribution businesses face unique challenges that outdated systems can't solve. Our ERP solution addresses these pain points directly."
        },
        items: [
          {
            icon: <Boxes className="h-6 w-6 text-primary/70" />, 
            question: "Inventory discrepancies leading to stockouts or overstock",
            answer: "Poor inventory tracking results in shortages or excess stock, tying up capital and impacting service levels."
          },
          {
            icon: <FileText className="h-6 w-6 text-primary/70" />,
            question: "Slow and error-prone order processing",
            answer: "Manual workflows increase the risk of order mistakes, delayed shipments, and frustrated customers."
          },
          {
            icon: <Map className="h-6 w-6 text-primary/70" />,
            question: "Lack of real-time visibility into supply chain movements",
            answer: "Without a centralized system, tracking shipments, orders, and inventory across multiple locations is challenging."
          },
          {
            icon: <Route className="h-6 w-6 text-primary/70" />,
            question: "High logistics costs due to inefficient routing",
            answer: "Suboptimal route planning and carrier management drive up transportation expenses and delivery times."
          },
          {
            icon: <Boxes className="h-6 w-6 text-primary/70" />,
            question: "Siloed systems affecting collaboration",
            answer: "Disconnected sales, inventory, and logistics systems create bottlenecks and miscommunications."
          },
          {
            icon: <Users className="h-6 w-6 text-primary/70" />,
            question: "Difficulty in meeting evolving customer expectations",
            answer: "Customers demand faster deliveries, accurate tracking, and personalized service that legacy systems can't provide."
          }
        ],
        footer: {
          header: {
...
// </div>
    ...
    <>
      ...
      <section className="container mx-auto px-4 md:px-6 py-16">
        ...
        <div className="space-y-24 mb-24">
          {industry?.section3.feature.map((section, index) => (
            <div
              key={index}
  ...
  data={
    industry?.section4.cards.map((card) => ({
      ...
      //   alt: card.image.alt,
      // },
      link: card.link?.map((button: Tbutton) => ({
        ...button,
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="pt-6">
            <Button size="lg" className="text-lg px-8 py-6">
              <Link href={industry?.section5.footer.button?.href ?? "/"}>{section5.footer.button.label}</Link>
            </Button>
          ...
          <div className="mt-12 text-center">
            <div className="space-y-4">
              ...
              <Button size="lg" className="group">
                <Link href={industry?.section6.footer.button?.href ?? "/"}>{section6.footer.button.label}</Link>
