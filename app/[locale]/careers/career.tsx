...
import { Tbutton, TcareersPageTarget } from "@repo/middleware";
import { JobData, JobFilters, TtrendCardProps } from "@repo/ui/type";
              ...
              <div className="relative overflow-hidden rounded-xl border border-border bg-background p-1 w-full">
                <div className="aspect-[4/3] relative">
                  <Image
                    ...
                    alt={idCareer.career.challengeSection.image.alternate}
                    fill
              ...
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-xl border border-border bg-background p-1">
                  <Image
                    ...
                    alt={idCareer.career.planSection.image.alternate}
                    width={600}
                    height={600}
