...
import { ArrowRight, Clock, DollarSign, FileText, Zap, Lock, Star, CheckCircle, Download, } from "lucide-react";
...
export default function Pricing({ idPricing }: { idPricing: TpricingPageTarget }) {
    ...
    console.log(idPricing.pricing.problemSection)

    // Function to get the icon component
    // const getIconComponent = (icon: string): Icons.LucideIcon => {
    //     return (Icons[icon as keyof typeof Icons] as Icons.LucideIcon) || Icons.Users;
    // };

    // Function to render the icon element
    // const renderIconElement = (icon: string) => {
    //     const safeIcon = icon ?? 'Users';
    //     const IconComponent = getIconComponent(safeIcon);
    //     return (
