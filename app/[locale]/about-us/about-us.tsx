                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="mt-10">
                            ...
                            <div
                                ...
                                onMouseEnter={() => { LdValuesPaused.current = true; }}
                                onMouseLeave={() => { LdValuesPaused.current = false; }}
                                onTouchStart={() => { LdValuesPaused.current = true; }}
                                onTouchEnd={() => { LdValuesPaused.current = false; }}
                                ...
                                {idAboutUs?.aboutUs.valuesSection.map((idValues, iIndex) => (
                                    <div
                                        ...
                                        className={`flex w-full shrink-0 snap-center flex-col border bg-accent p-8 transition-colors duration-300 md:p-12 ${
                                            LActiveValue === iIndex ? "border-primary/30" : "border-primary/10"
                                        }`}
                                    >
                                        {fnRenderIcon(idValues.badge)}
                                        <h3 className="text-2xl font-light mb-4 md:text-3xl break-words text-primary">{idValues.title}</h3>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="mt-12 ml-4 border-l border-primary/20 md:ml-5">
                            ...
                            {LdYearGroups && LdYearGroups.length > 0 && (() => {
                                const endYear= LdYearGroups[LdYearGroups.length - 1]?.year;
                                const startYear = LdYearGroups[0]?.year;
                                const historyLabel = startYear && endYear && startYear !== endYear ? `${startYear} — ${endYear}` : "Previous Years";
                                ...
                                return (
                                    <div className="relative pl-8 md:pl-12">
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => fnSetHistoryAccordionOpen(!LHistoryAccordionOpen)}
                                        ...
                                        >
                                            <span
                                                className="absolute -left-8 top-1/2 z-10 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full ring-4 ring-background transition-colors duration-300 md:-left-12 bg-primary"
                                            />
                                            ...
                                            <ChevronDown className={`h-5 w-5 flex-shrink-0 text-primary/50 transition-transform duration-300 ${LHistoryAccordionOpen ? "rotate-180" : ""}`} />
                                        </button>

                                        {/* Master History Drawer */}
                                        <div className={`grid transition-all duration-300 ease-in-out ${LHistoryAccordionOpen ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}>
                                            <div className="overflow-hidden">
                                                {/*NESTED ACCORDIONS INSIDE HISTORY */}
                                                    {LdYearGroups.map((idGroup) => {
                                                        const LYearOpen = LOpenHistoryYear === idGroup.year;
                                                        return (
                                                            <div className="relative pl-6" key={idGroup.year}>
                                                                <button
                                                                    type="button"
                                                                    onClick={() => fnToggleHistoryYear(idGroup.year)}
                                                                ...
                                                                >
                                                                    ...
                                                                    <ChevronDown className={`h-4 w-4 flex-shrink-0 text-primary transition-transform duration-300 ${LYearOpen ? "rotate-180" : ""}`} />
                                                                </button>

                                                                {/* Individual Year Milestone Content */}
                                                                <div className={`grid transition-all duration-300 ease-in-out ${LYearOpen ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}>
                                                                    <div className="overflow-hidden">
                                ...
                                return (
                                    <div className="relative pl-8 md:pl-12 mt-6">
                                        ...
                                        >
                                            ...
                                            <ChevronDown className={`h-5 w-5 flex-shrink-0 text-primary/50 transition-transform duration-300 ${LYearOpen ? "rotate-180" : ""}`} />
                                        </button>
                                        <div className={`grid transition-all duration-300 ease-in-out ${LYearOpen ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}>
                                            <div className="overflow-hidden">
                                ...
                                {idAboutUs.aboutUs.ctaSection.buttons.map((idBtn, iIndex) => (
                                    idBtn.href ? (
                                        <Link href={idBtn.href} className="border border-background p-6 hover:bg-foreground transition-colors group" key={iIndex}>
                                            {fnRenderIcon(idBtn.icon, "h-8 w-8 text-background mb-4 mx-auto")}
