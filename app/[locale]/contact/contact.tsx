...
import { TcontactTarget } from "@repo/middleware/type";
import { generateSchemaFromFields } from "@repo/ui/lib/zodTransformation";

export default function ContactChildPage({
  idContact,
}: {
  idContact: TcontactTarget;
}) {
  ...
  const LdBookingForm = idContact.forms.find(
    (form) => form.formId === "booking"
  );
  const LdContactForm = idContact.forms.find(
    (form) => form.formId === "contact"
  );
            ...
            <div className="md:col-span-4 md:sticky md:top-8 flex items-center justify-center order-1">
              <div className="text-center md:text-left max-w-md w-full">
                <TitleSubtitle
                  idTitle={{
                    headingClass:
                      "text-3xl md:text-5xl font-light md:mb-2 text-foreground",
              ...
              >
                ...
                <SectionForm
                  config={{
                    ...
                    schema: generateSchemaFromFields(
                      idContact.contact.contactForm || []
                    ),
                  }}
      ...
      <div className="py-12 md:py-16 relative overflow-hidden">
        <div className="container mx-auto px-6 relative">
          <div className="max-w-7xl">
            <p className="text-foreground text-sm tracking-widest uppercase mb-6 text-center">
              {idContact.contact.locationHeadline}
            </p>
            <TitleSubtitle
              idTitle={{
                ...
                headingClass:
                  "text-4xl md:text-6xl font-light mb-8 leading-tight text-foreground",
                descripClass:
                  "text-xl text-foreground max-w-2xl mx-auto leading-relaxed",
              }}
            />
          </div>
        </div>
